...
```quote author="Конфуций (Аналектa)"
...
```quote author="Дао Дъ Дзин"
Дао, което може да се назове, не е вечното Дао. Името, което може да бъде назовано, не е вечното име.
```
